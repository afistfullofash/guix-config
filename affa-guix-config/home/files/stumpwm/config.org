...
#+begin_src lisp
  ...
  (defun light-bg () (ml-background-color (slot-value (with-current-theme) 'red)))
  (defun medium-bg () (ml-background-color (slot-value (with-current-theme) 'custom-one)))
  (defun dark-bg () (ml-background-color (slot-value (with-current-theme) 'custom-two)))
